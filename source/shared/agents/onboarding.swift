...
let SAND_ONBOARDING_KICKSTART_PROMPT = [
...
let INTRODUCTION_FAILED_TRAY_TITLE = "Your agent couldn't introduce itself"

func introductionFailedTrayKey(_ agentId: String) -> String {
    "introduction-failed:\(agentId)"
}
