...
if internal_host_extensions.is_file() and internal_scheduling.is_file() and mobile_ffi.is_file():
    ...
    for required_module in [
        ...
        "packages/cursor-plugins/snapshot-state.rs",
        "packages/local-exec/pi/truncate.rs",
        "packages/hooks-carriers/limits.rs",
        "packages/mcp-core/config/mcp-focus-retry-cooldown.rs",
        "packages/mcp-core/config/mcp-fsm-timing-config.rs",
        "packages/mcp-core/config/mcp-inline-reconnect-cooldown.rs",
        "packages/local-exec/constants.rs",
        "packages/agent/utils/token-estimate.rs",
        "packages/agent/utils/prompt-xml-escape.rs",
